...
## Introduction
This README provides instructions on how to compile and run our SimCity Project 2 Final program using PuTTY. This version requires compiling the following files: 'main.cpp', 'residential.h', 'industrial.h', 'commercial.h', 'pollution.h', 'functions.h', 'readwrite.h', 'zoom.h', 'residential.cpp', 'industrial.cpp', 'commercial.cpp', 'pollution.cpp', 'functions.cpp', 'readwrite.cpp', 'zoom.cpp', 'config2.txt', 'region2.csv'
- These files were all provided in the submission zip. To run the program using different configuration and region files, please ensure you store then in the same directory as the required files.
